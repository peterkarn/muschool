window.addEventListener('DOMContentLoaded', () => {
  ...
  //    let maxHeight = document.querySelector('.text-shops__body_all').offsetHeight + document.querySelector('.shops__caption').offsetHeight;
  //    console.log(maxHeight);
  //    document.querySelectorAll('.shops__horizontal-slide').forEach(element => {
  //      element.style.height = `${maxHeight + 80}px`
  //    });
  //  }
